            ...
            <form method="POST" action="{{ route('items.store') }}" enctype="multipart/form-data">
                ...
                <div class="sell-section">
                    ...
                    <div class="form-group">
                        ...
                        <select name="condition_id" class="form-input @error('condition_id') is-invalid @enderror">
                ...
                <div class="sell-section">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" class="form-input sell-textarea @error('description') is-invalid @enderror" maxlength="255">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="error-message">{{ $message }}</p>
                        @enderror
                    </div>
