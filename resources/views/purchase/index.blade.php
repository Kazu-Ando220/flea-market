    ...
    <div class="content-wrapper">
        <div class="purchase-container">
                ...
                <form method="POST" action="{{ route('purchase.store', $item->id) }}" id="purchase-form">
                    ...
                    <section class="selection-section">
                        ...
                        <select name="payment_method"
                            class="purchase-select js-payment-select @error('payment_method') is-invalid @enderror">

                            <option value="" disabled {{ !$selectedPayment ? 'selected' : '' }}>
                                選択してください
                            </option>

                            <option value="コンビニ支払い" {{ $selectedPayment === 'コンビニ支払い' ? 'selected' : '' }}>
                                コンビニ支払い
                            </option>

                            <option value="カード支払い" {{ $selectedPayment === 'カード支払い' ? 'selected' : '' }}>
                                カード支払い
                            </option>
            ...
            <div class="purchase-right">
                ...
                <button type="submit" form="purchase-form" class="btn-purchase" {{ $item->is_sold ? 'disabled' : '' }}>
